                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="media">
                                    ...
                                    <img class="testimonial-author-img ml-3" src="{{asset('admin-assets/images/avatar/1.png')}}" alt="" />
                                </div>
                            </div>
                        </div>
                        <div class="item">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="round-img">
                                        <a href=""><img width="35" src="{{asset('admin-assets/images/avatar/1.png')}}" alt=""></a>
                                    </div>
                                </td>
                                <td>Lew Shawon</td>
