                   ...
                   <div class="position-relative">
                       <div class="position-relative mb-3">
                           <button
                               ...
                               src="{{asset($item->main_image)}}" alt="Image">
                       </div>
                       <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="{{ url('/detail',['slug'=>$item->slug]) }}">{{$item->title}}</a></h3>
                       <ul class="list-inline mb-0 fs-sm">
                           ...
                           <li class="list-inline-item ps-1"><i
                                   class="fi-credit-card mt-n1 ms-1 fs-base text-muted align-middle"></i>{{$item->price}}
                               تومان</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <ul class="list-unstyled delay-2 from-end">
                                <li class="mb-1 fs-sm"><i class="fi-map-pin text-muted me-2 fs-base"></i>اصفهان </li>
                            </ul>
                             <p class="pb-2 delay-3 from-end d-none d-lg-block line-h18">پل خواجو از پل‌های تاریخی و زیبای اصفهان است که در عصر خود، جزو زیباترین پل‌های دنیا به شمار می‌رفت. قدم زدن روی این پل،‌ به‌خصوص هنگام غروب و اوایل شب، از لذت‌بخش‌ترین تفریح‌هایی است که گردشگران در برنامه خود قرار می‌دهند. این پل که از دیدنی‌های اصفهان است و سفر به نصف جهان بدون دیدن آن کامل نمی‌شود، علاوه بر زیبایی، اسرار و شگفتی‌هایی دارد که بسیاری را وادار می‌کند تا با نگاهی ریزبینانه قدم بر این پل بگذارند و با همه وجود آن را درک کنند</p>
                                <a
